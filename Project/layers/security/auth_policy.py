...
class AuthPolicy(object):
    ...
    # these are the internal lists of allowed and denied methods. These are lists of objects and each object
    # has 2 properties: A resource ARN and a nullable conditions statement.The build method processes these
    ...
    def __init__(self, principal, aws_account_id, region, stage, rest_api_id):
